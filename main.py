...
with open('C:\pythonProject1\orca-py\graph_dpr_polblogs.out', 'r') as file:
...
######################### Loding the dataset   #########################
data = Dataset(root='C:\pythonProject1', name='polblogs')
...
############## RANDOM ATTACKS  #############
        ...
        for target_node in tqdm(node_list):
            ...
            acc_gcn = test_GIN(modified_adj, data, target_node)
            print('class : %s' % acc_gcn)
            if acc_gcn == 0:
                cnt_gat += 1
...
######################################### 1819  ###############################
        ...
        print('Missclassification rate for 1819 : %s' % (cnt_gat / num))
        ...
        print('Missclassification rate for 1519 : %s' % (cnt_gat / num))
        ...
        print('========= TESTING with 1922 nodes =========')

        print('Missclassification rate for 1922 : %s' % (cnt_gat / num))

        miss[7][gp] = cnt_gat / num
